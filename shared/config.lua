...
Config.RepairKitEnabled = true
Config.RepairBayEnabled = false
...
Config.RepairBays = {
    ...
    {location = vec3(425.69, -1021.96, 28.91), name = 'Repair Bay2', sprite = 402, blipColour = 0, price = 6000, range = 5, blip = true}
}