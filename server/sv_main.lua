...
RegisterNetEvent('hx_repair:server:removeKit', function()
    if exports.ox_inventory:GetItemCount(source, 'repairkit') < 1 then
        DropPlayer('Attempting to remove item with executor')
    elseif exports.ox_inventory:GetItemCount(source, 'repairkit') >= 1 then
